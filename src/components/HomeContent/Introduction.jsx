...
const Introduction = () => {
  return (
    <Tilt transitionSpeed={3500} tiltMaxAngleX={12} tiltMaxAngleY={12}>
      <div className="max-w-[550px] md:h-[440px] flex flex-col items-center justify-center bg-slate-800 border border-slate-400 rounded-tl-[15px] rounded-tr-[70px] rounded-br-[15px] rounded-bl-[70px] p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30">
